    ...
    <div className="space-y-6">
      <div className="space-y-2">
        <Link href="/" className="group inline-flex items-center px-0.5 text-sm font-medium">
          ...
          <span className="underline-offset-4 group-hover:underline">Află mai multe despre clienții tăi {selectedDb === "UT_database" ? "UT" : "CC"}</span>
        ...
        <p className="max-w-2xl text-lg font-light text-foreground">
          Statistici despre clienții {selectedDb === "UT_database" ? "UT" : "CC"} și informații care te pot ajuta să-ți înțelegi mai bine clienții
        </p>
      </div>
      ...
      <div className="p-4 mt-8 rounded-lg bg-muted">
        <p className="text-sm text-muted-foreground">
          În cadrul acestei prezentări veți regăsi o analiză cu privire la satisfacția clienților 
          CEC Bank, analiza desfășurată în perioada anului 2024 în colaborare cu Optima Solutions 
          Services, în care am analizat următoarele aspecte:
