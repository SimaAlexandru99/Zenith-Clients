    ...
    <div className="flex flex-col gap-4 p-4 md:gap-8 md:p-8">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            <p>Acesta este dashboard-ul de control unde poți accesa analize și rapoarte legate de controlul clienților.</p>
        ...
        <Card>
          ...
          <CardContent>
            <p>Acesta este dashboard-ul pentru urmărirea utilizatorilor, unde poți accesa analize detaliate și monitoriza comportamentul utilizatorilor.</p>
