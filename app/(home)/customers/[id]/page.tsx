        ...
        <CardContent>
          <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <dt className="text-sm font-medium text-gray-500">T1. Buna ziua. Numele meu este…</dt>
            ...
            <div className="sm:col-span-2">
              <dt className="text-sm font-medium text-gray-500">T2.1. Nu va retin foarte mult...</dt>
              <dd className="mt-1 text-sm">
                {
                  customer[
